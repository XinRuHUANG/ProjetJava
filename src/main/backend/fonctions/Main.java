...
public class Main extends Application {
    ...
    public void showDepotView() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/main/view/Depot.fxml"));
            Parent root = loader.load();
    ...
    public void showPointsView() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/main/view/Points.fxml"));
            Parent root = loader.load();
    ...
    public void showMenuUtilisateurView(Utilisateur currentUser) {

    }

    public void showPromotionsView() throws IOException {
        try{
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/main/view/Promotions.fxml"));
        Parent root = loader.load();

        PromotionsController controller = loader.getController();
        controller.setMainApp(this);
        controller.setUtilisateur(currentUser);

        Stage PointStage = new Stage();
        PointStage.setScene(new Scene(root));
        PointStage.show();
        }catch (Exception e) {
            e.printStackTrace();
            System.err.println("Erreur lors du chargement de l'interface");
